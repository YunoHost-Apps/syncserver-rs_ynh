...
<img width="400" src="screenshots/admin-01.png" alt="Firefox's warning page for the about:config page, titled 'Proceed with caution'">
...
<img src="screenshots/admin-02.png" width="400" alt="about:config screen with identity.sync.tokenserver.uri setting">
...
<img src="screenshots/admin-03.png" width="400" alt="About Firefox screen">

Tap on the logo 3-4 times until you see the "Debug menu enabled" notification at
the bottom of your screen.

<img src="screenshots/admin-04.png" width="400" alt="Debug menu enabled notification">

Now, you should have a "Sync debug" menu at the top of your Settings.

<img src="screenshots/admin-05.png" width="400" alt="Sync debug menu in Firefox for Android settings">
...
<img src="screenshots/admin-06.png" width="400" alt="Sync debug settings">
